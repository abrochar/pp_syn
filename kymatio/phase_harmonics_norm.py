        ...
        if self.chunk_id < self.nb_chunks:
            ...
            for idxb in range(nb):
                for idxc in range(nc):
                    ...
                    xpsi_bc = xpsi_bc.view(1,J*L2*(dn+1),M,N,2)
                    ...
                    # div by initial std
                    xpsi0_bc_la1k1_n = self.divinitstd1(xpsi0_bc_la1k1) # (1,P_c,M,N,2)
                    xpsi0_bc_la2k2_n = self.divinitstd2(xpsi0_bc_la2k2) # (1,P_c,M,N,2)
                    # compute mean spatial
                    corr_xpsi_bc = mulcu(xpsi0_bc_la1k1_n,xpsi0_bc_la2k2_n) # (1,P_c,M,N,2)
